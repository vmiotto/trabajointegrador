...
.then(function(data){
    ...
    main.innerHTML = `    <div class="seriedetallada">
    <h1>${data.name}</h1>
    ...
    <h2 class="h2fechadeestreno"> ${data.first_air_date}</h2>
    <h2 class="h2duracion"> ${data.number_of_episodes} episodios</h2>
    <h2 class="h2sinopsis">${data.overview}</h2>
    <h2 class="h2genero">Pelicula de ${generos}</h2>`



let divFoto = document.querySelector('.seriedetallada')
console.log(divFoto)
